...
public class NodeToken implements Node {
   ...
   public NodeToken(String s, int kind, int beginLine, int beginColumn, int endLine, int endColumn, int beginOffset, int endOffset) {
      tokenImage = s;
      specialTokens = null;
      this.kind = kind;
   ...
   public int beginLine, beginColumn, endLine, endColumn, beginOffset, endOffset;
