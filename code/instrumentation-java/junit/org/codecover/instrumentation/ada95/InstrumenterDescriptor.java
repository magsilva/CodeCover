...
package org.codecover.instrumentation.ada95;
 ...
 * 
 * @version 1.0 ($Id: InstrumenterDescriptor.java 1527 2007-06-29 20:47:09Z
 *          muellecr $)
 */
public class InstrumenterDescriptor extends
    ...
    public boolean isLanguageSupported(String languageNameToCheck) {
        return Pattern.compile("Ada( 95)?", Pattern.CASE_INSENSITIVE).matcher(languageNameToCheck).matches();
    }
