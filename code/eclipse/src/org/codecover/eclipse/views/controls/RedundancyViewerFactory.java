...
import org.codecover.eclipse.views.RedundancyGraphView;
...
/**
 * This {@link RedundancyViewerFactory} 
 * 
...
public class RedundancyViewerFactory {
    ...
    private static final String COLUMN_LABEL_REDUNDANCY = Messages
            .getString("RedundancyViewerFactory.COLUMN_LABEL_REDUNDANCY"); //$NON-NLS-1$
    
    private static final String COLUMN_LABEL_ST_REDUNDANCY = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_ST_REDUNDANCY"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_BR_REDUNDANCY = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_BR_REDUNDANCY"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_COND_REDUNDANCY = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_COND_REDUNDANCY"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_LOOP_REDUNDANCY = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_LOOP_REDUNDANCY"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_COVEREDITEMS = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_COVEREDITEMS"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_ST_COVEREDITEMS = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_ST_COVEREDITEMS"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_BR_COVEREDITEMS = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_BR_COVEREDITEMS"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_COND_COVEREDITEMS = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_COND_COVEREDITEMS"); //$NON-NLS-1$

    private static final String COLUMN_LABEL_LOOP_COVEREDITEMS = Messages
    .getString("RedundancyViewerFactory.COLUMN_LABEL_LOOP_COVEREDITEMS"); //$NON-NLS-1$
    ...
    public static CheckboxTreeViewer newCheckboxTreeViewer(
        ...
        CheckboxTreeViewer viewer = new CheckboxTreeViewer(
                ...
                RedundancyViewerFactory.STYLE);
        RedundancyViewerFactory.configureViewer(  viewer,
    ...
    private static void configureViewer(    final TreeViewer viewer,
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	String str1 = this.lblProvider.getColumnText(o1,Columns.ST_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	String str2 = this.lblProvider.getColumnText(o2,Columns.ST_REDUNDANCY
                        .getIndex(withTestSessionColumn));
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	String str1 = this.lblProvider.getColumnText(o1,Columns.BR_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	String str2 = this.lblProvider.getColumnText(o2,Columns.BR_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	if(str1.compareTo("NaN") ==0)
            		return 1;
            	else if (str2.compareTo("NaN") ==0)
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	String str1 = this.lblProvider.getColumnText(o1,Columns.COND_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	String str2 = this.lblProvider.getColumnText(o2,Columns.COND_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	if(str1.compareTo("NaN") ==0)
            		return 1;
            	else if (str2.compareTo("NaN") ==0)
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	String str1 = this.lblProvider.getColumnText(o1,Columns.LOOP_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	String str2 = this.lblProvider.getColumnText(o2,Columns.LOOP_REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	if(str1.compareTo("NaN") ==0)
            		return 1;
            	else if (str2.compareTo("NaN") ==0)
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	String str1 = this.lblProvider.getColumnText(o1,Columns.REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	String str2 = this.lblProvider.getColumnText(o2,Columns.REDUNDANCY
                        .getIndex(withTestSessionColumn));
            	if(str1.compareTo("NaN") ==0)
            		return 1;
            	else if (str2.compareTo("NaN") ==0)
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	int a = Integer.parseInt(this.lblProvider.getColumnText(o1,Columns.ST_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
            	int b = Integer.parseInt(this.lblProvider.getColumnText(o2,Columns.ST_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
                if( a <= b)
                	return 1;
                else
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	int a = Integer.parseInt(this.lblProvider.getColumnText(o1,Columns.BR_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
            	int b = Integer.parseInt(this.lblProvider.getColumnText(o2,Columns.BR_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
                if( a <= b)
                	return 1;
                else
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	int a = Integer.parseInt(this.lblProvider.getColumnText(o1,Columns.COND_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
            	int b = Integer.parseInt(this.lblProvider.getColumnText(o2,Columns.COND_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
                if( a <= b)
                	return 1;
                else
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	int a = Integer.parseInt(this.lblProvider.getColumnText(o1,Columns.LOOP_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
            	int b = Integer.parseInt(this.lblProvider.getColumnText(o2,Columns.LOOP_COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
                if( a <= b)
                	return 1;
                else
        ...
        column = new TreeColumn(viewer.getTree(),
        		SWT.LEAD,
        		Columns.COVEREDITEMS.getIndex(withTestSessionColumn));
        ...
        new ViewerSorter(viewer, column, new String[] {UPDATE_PROPERTY_DATE}) {
            ...
            @Override
            protected int doCompare(Viewer viewer, Object o1, Object o2) {
            	int a = Integer.parseInt(this.lblProvider.getColumnText(o1,Columns.COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
            	int b = Integer.parseInt(this.lblProvider.getColumnText(o2,Columns.COVEREDITEMS
                        .getIndex(withTestSessionColumn)));
                if( a <= b)
                	return 1;
                else
