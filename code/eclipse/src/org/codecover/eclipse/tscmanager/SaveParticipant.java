...
public interface SaveParticipant {
     ...
     * {@link org.eclipse.core.resources.ISaveParticipant#saving(ISaveContext)}
     * (of the {@link org.eclipse.core.resources.ISaveParticipant} which uses
     * this <code>SaveParticpant</code>) completed without exceptions and the
     * save operation failed because of an <em>other</em>
     ...
     * See
     * {@link org.eclipse.core.resources.ISaveParticipant#saving(ISaveContext)},
     * but do <em>not</em> call {@link ISaveContext#needSaveNumber()} and
     * <em>do</em> return the appropriate return value if saving was successful
     * or didn't take place. If saving wasn't successful throw a
     ...
     *                if this method fails to snapshot the state of this
     *                workspace.
     * @return <code>true</code> if something was saved by this
     *         <code>SaveParticipant</code>, <code>false</code> otherwise
     */
