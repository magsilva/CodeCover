...
m4_web_create_page_header(`Installation Guide')
    ...
    <h3>The software you need to run CodeCover</h3>
    The following software packages must be installed before you install CodeCover:
    <ul>
...
<li>After the download has finished, Eclipse will ask you some question about the license and installation, and prompt to restart the workbench. You should confirm the restart as not all CodeCover features are guaranteed to work if you simply click &quot;Apply Changes&quot;.</li>
</ol>
