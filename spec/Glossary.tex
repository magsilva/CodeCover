...
description={is a \gl{coverage criterion}. Statement coverage defines the \gl[coverable item]{coverable items} as \gl[basic statement]{basic statements}. A coverable item is covered, if the basic statement is successfully executed.}
}
